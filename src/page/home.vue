    ...
    <div>
		...
		<section class="data_section">
			...
			<el-row :gutter="20" style="margin-bottom: 10px;">
				...
				<el-col :span="4"><div class="data_list"><span class="data_num">{{messageCount}}</span> 新增留言</div></el-col>
				<el-col :span="4"><div class="data_list"><span class="data_num">{{ideaCount}}</span> 反馈意见</div></el-col>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4"><div class="data_list"><span class="data_num">{{allUserCount}}</span> 留言总数</div></el-col>
